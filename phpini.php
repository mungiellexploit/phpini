...
</div><div class="bg-dark border table-responsive mt-2"><div class="ml-2" style="font-size:18px;"><span>Path Dir: </span>
...
<table class="table table-hover table-borderless table-sm"><thead class="text-light"><tr><th>Name File</th><th>Size File</th><th>Permission</th><th>Action</th></tr></thead><tbody class="text-light">
